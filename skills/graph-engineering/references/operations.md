...
- Install: `npx skills add AskRealMe/graph-engineering-skills --skill graph-engineering --agent codex`. Use project scope unless personal installation is requested; then add `--global`. Inspect an already supplied skill instead of reinstalling blindly.
